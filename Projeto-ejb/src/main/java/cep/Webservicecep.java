...
public class Webservicecep {
    ...
    public String toString() {
        return "Webservicecep{" + "resultado=" + resultado + ", resultado_txt=" + resultado_txt + ", uf=" + uf + ", cidade=" + cidade + ", bairro=" + bairro + ", tipo_logradouro=" + tipo_logradouro + ", logradouro=" + logradouro + '}';
    }
